        ...
        <div className="relative z-10 text-white">
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="font-semibold">Professional Portfolio</h3>
                <p className="text-sm text-blue-100 mt-1">Build and showcase your professional achievements and qualifications</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              <CheckCircle className="h-6 w-6 mr-3 text-blue-200" />
              <div>
                <h3 className="font-semibold">Track Qualifications</h3>
                <p className="text-sm text-blue-100 mt-1">Manage and monitor your professional development progress</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-blue-100 mt-1">Connect your teaching practice with the latest educational research</p>
              </div>
            </div>
            
            <div className="mt-8 pt-6 border-t border-blue-400">
              <h3 className="font-semibold mb-2">Trusted by Leading Institutions</h3>
              <p className="text-sm text-blue-100">Join practitioners from universities and schools across the country</p>
            </div>
          </div>
        </div>
      </div>
