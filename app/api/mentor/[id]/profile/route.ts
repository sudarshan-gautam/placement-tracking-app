...
export async function PATCH(
  ...
  try {
    console.log('Starting mentor profile PATCH handler for id:', params.id);
    ...
    const { bio, education, graduation_year, preferred_job_type, preferred_location, name, phone, secondary_email, social_media, profileImage, coverImage } = requestBody;
