...
export async function POST(
  ...
  try {
    console.log('Processing admin profile image upload for id:', params.id);
    ...
    if (!decoded || decoded.id !== params.id || decoded.role !== 'admin') {
      console.log('Authorization failed, decoded ID does not match params ID or role is not admin');
