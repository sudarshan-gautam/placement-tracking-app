      ...
      <div className="mb-8">
        ...
        <div className="space-y-2">
          <div 
            ...
            className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 transition-colors duration-150 cursor-pointer flex items-center"
          >
            ...
            <span className="text-lg font-medium text-gray-900">Add User</span>
          </div>
          
          <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 transition-colors duration-150 cursor-pointer flex items-center">
            <div className="text-indigo-600 mr-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25a3 3 0 013 3m3 0a6 6 0 01-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 1121.75 8.25z" />
              </svg>
            </div>
            <span className="text-lg font-medium text-gray-900">Modify Roles</span>
          </div>
          ...
          <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 transition-colors duration-150 cursor-pointer flex items-center">
            ...
            <span className="text-lg font-medium text-gray-900">Reset Credentials</span>
          </div>
          ...
          <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 transition-colors duration-150 cursor-pointer flex items-center">
            ...
            <span className="text-lg font-medium text-gray-900">Update Resources</span>
          </div>
          ...
          <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 transition-colors duration-150 cursor-pointer flex items-center">
            ...
            <span className="text-lg font-medium text-gray-900">Manage Templates</span>
          </div>
          ...
          <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 transition-colors duration-150 cursor-pointer flex items-center">
            ...
            <span className="text-lg font-medium text-gray-900">Generate Reports</span>
          </div>
        </div>
      </div>
