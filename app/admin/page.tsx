...
import { User, Settings, Shield, Users, ClipboardCheck, Bell, BarChart2, Server, Plus, LayoutDashboard, BookOpen, Award } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  // If not authenticated or user is not admin, don't render anything (will be redirected)
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 pb-40">
      ...
      {/* Main content without sidebar padding */}
      <div>
        {/* 2. OVERVIEW METRICS */}
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 z-20">
        <div className="flex justify-around max-w-4xl mx-auto">
          <Link href="/admin" className="flex flex-col items-center text-blue-600">
            <LayoutDashboard className="h-6 w-6" />
            <span className="text-xs">Admin</span>
          </Link>
          <Link href="/admin/users" className="flex flex-col items-center text-gray-600 hover:text-blue-600">
            <Users className="h-6 w-6" />
            <span className="text-xs">Users</span>
          </Link>
          <Link href="/admin/verifications" className="flex flex-col items-center text-gray-600 hover:text-blue-600">
            <ClipboardCheck className="h-6 w-6" />
            <span className="text-xs">Verifications</span>
          </Link>
          <Link href="/admin/settings" className="flex flex-col items-center text-gray-600 hover:text-blue-600">
