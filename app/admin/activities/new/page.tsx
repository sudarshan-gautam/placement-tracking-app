...
export default function NewAdminActivityPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const activityData = {
        ...
        status: 'submitted', // Activities created by admins are automatically submitted
  ...
  if (!user || user.role !== 'admin') {
    return null; // Don't render anything if not authenticated or not an admin
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      {/* Back Button */}
      <div className="mb-6">
        <Link href="/admin/activities" className="inline-flex items-center text-blue-600 hover:text-blue-800 mb-4">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">
          Assign a new professional development activity to a student
        </p>
      </div>
