...
import { FileText, Trash, Edit, Plus, Eye, Check, AlertCircle } from 'lucide-react';
import { 
  ...
  const handleCreateTemplate = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const updatedResponse = await fetch('/api/admin/cv-templates', {
          headers: {
            'Authorization': `Bearer ${token}`
          }
        });
        ...
        <TabsContent value="templates">
          {isLoading ? (
            ...
            <div className="text-center py-12 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <p className="mt-1 text-sm text-gray-500">Get started by creating a new CV template.</p>
              <Button 
        ...
        <TabsContent value="categories">
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <p className="text-gray-500 mb-4">
              Organize your CV templates by category to help students find the right template for their needs.
            </p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
              {['General', 'IT/Technology', 'Creative', 'Academic', 'Entry Level', 'Executive'].map(category => (
                <div key={category} className="flex items-center p-3 bg-gray-50 rounded-md border border-gray-200">
      ...
      <Dialog open={showNewTemplateDialog} onOpenChange={setShowNewTemplateDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new CV template that students can use to build their CVs.
            </DialogDescription>
          </DialogHeader>
